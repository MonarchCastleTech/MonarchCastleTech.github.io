...
test("live site health script covers canonical routes and dashboard data freshness", () => {
  ...
  for (const path of ["/", "/404.html", "/platform/", "/impact/", "/pricing/", "/pilot/", "/insights/", "/insights/feed.xml", "/sitemap.xml", "/robots.txt", "/llms.txt", "/llms-full.txt", "/ai.txt", "/agents.txt", "/site.webmanifest", "/.well-known/ai-catalog.json", "/tools/", "/mcp/", "/sdcofa/", "/sdcofa/bnti/", "/sdcofa/wti/", "/sdcofa/mena/"]) {
