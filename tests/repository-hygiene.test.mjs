...
test("MonarchCastleTech/MonarchCastleTech.github.io exposes the complete repository documentation contract", () => {
...
test("MonarchCastleTech/MonarchCastleTech.github.io keeps every managed image local and ships a valid social preview", () => {
...
test("MonarchCastleTech/MonarchCastleTech.github.io documents citation, rights, and HTTPS policy", () => {
