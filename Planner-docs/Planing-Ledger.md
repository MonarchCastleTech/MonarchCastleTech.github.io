...
- 2026-09-23: rescan still fail — AS metadata needed `agent_auth` block, supportedInterfaces entries needed `url`; added both; test 67/67 + test:dist 9/9 + verify-dist pass
