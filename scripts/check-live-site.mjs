...
const routeChecks = [
  { path: "/", markers: ["Know how global change reaches your business.", "assets/products/logo.png", 'id="sdcofa"', 'id="answers"', "Frequently asked questions"] },
  { path: "/404.html", markers: ["Page not found", "llms.txt", "noindex"] },
  { path: "/platform/", markers: ["A unified early-warning workspace", "scripts/platform.js", "metric-mena"] },
  ...
  { path: "/llms.txt", markers: ["Monarch Castle Technologies", "Current signals", "GET https://monarchcastle.com/api/bnti", "## FAQ", "## Quick facts"] },
  { path: "/llms-full.txt", markers: ["## Entity definitions", "## FAQ", "## Standing index APIs"] },
  { path: "/ai.txt", markers: ["Discovery endpoints", "GET https://monarchcastle.com/api"] },
  { path: "/agents.txt", markers: ["Machine interfaces", "https://monarchcastle.com/api"] },
  { path: "/site.webmanifest", markers: ["Monarch Castle Technologies", "/llms.txt"] },
  { path: "/.well-known/ai-catalog.json", markers: ["standing index JSON API", "MCP endpoint"] },
  { path: "/tools/", markers: ["Tools", "Calculators"] },
  { path: "/mcp/", markers: ["MCP", "catalog", "REST JSON API", "/api/bnti"] },
